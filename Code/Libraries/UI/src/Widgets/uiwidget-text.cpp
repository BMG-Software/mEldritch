...
void UIWidgetText::SetString( const SimpleString& TheString )
{
	m_String = TheString;
	UpdateRender();
}
...
void UIWidgetText::UpdatePosition()
{
	...
	m_Font->Arrange( CodePoints, SRect( 0.0f, 0.0f, m_WrapWidth, 0.0f ), m_FontPrintFlags, UnusedTypesetting, Dimensions );
