	...
	const Array<WBAction*>* const	pNoActions )
{
	...
	pDialog->m_String = ConfigManager::GetLocalizedString( YesNoString, YesNoString.CStr() );
	pDialog->m_DynamicString = ConfigManager::GetLocalizedString( YesNoDynamicString, YesNoDynamicString.CStr() );
