...
public:
	...
	void				DeferredAddWidget( UIWidget* pNewWidget );
	...
	Array< UIWidget* >				m_DeferredWidgets;	// Widgets added by other widgets, deferred so that they may be added after all other widgets
