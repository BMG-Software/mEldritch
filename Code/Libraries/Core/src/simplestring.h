...
public:
	...
	bool			StrILt( const SimpleString& String ) const;
	...
	SimpleString	Replace( uint Index, const char* const Replace ) const;
	...
	static SimpleString	PrintF( const SimpleString FormatString, ... );
