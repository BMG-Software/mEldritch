...
public:
	...
	static void				PushEnvironment();
	static void				MergeEnvironment();
	static void				PopEnvironment();
	static void				RemoveContext( const STRING_TYPE& Context );

#if BUILD_DEBUG
	// this is a debugging aid
	static void Query( const char* Name, const char* Context = NULL );
#endif
...
private:
	...
	typedef Map< HashedString, VarMap >		Vars;
	Vars						*m_Vars;	// 2-D map--contexts by config names
	Array< Vars > 				m_Environment;
