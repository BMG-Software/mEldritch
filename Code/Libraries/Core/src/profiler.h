...
#define DO_PROFILING ( BUILD_WINDOWS && BUILD_DEV && !__GNUC__ )
...
#else
#define DEBUG_PROFILE_FUNCTION ((void)0)
#define DEBUG_PROFILE_SCOPE ((void)0)
#define DEBUG_PROFILE_BEGIN(n) ((void)0)
#define DEBUG_PROFILE_END ((void)0)
#define DEBUG_FRAME_PROFILE_FUNCTION ((void)0)
#define DEBUG_FRAME_PROFILE_SCOPE ((void)0)
#define DEBUG_FRAME_PROFILE_BEGIN(n) ((void)0)
#define DEBUG_FRAME_PROFILE_END ((void)0)
#endif
...
#define PROFILE_BEGIN(n) ((void)0)
#define PROFILE_END ((void)0)

#define FRAME_PROFILE_FUNCTION ((void)0)
#define FRAME_PROFILE_SCOPE(n) ((void)0)
#define FRAME_PROFILE_BEGIN(n) ((void)0)
#define FRAME_PROFILE_END ((void)0)

#define DEBUG_PROFILE_FUNCTION ((void)0)
#define DEBUG_PROFILE_SCOPE(n) ((void)0)
#define DEBUG_PROFILE_BEGIN(n) ((void)0)
#define DEBUG_PROFILE_END ((void)0)

#define DEBUG_FRAME_PROFILE_FUNCTION ((void)0)
#define DEBUG_FRAME_PROFILE_SCOPE(n) ((void)0)
#define DEBUG_FRAME_PROFILE_BEGIN(n) ((void)0)
#define DEBUG_FRAME_PROFILE_END ((void)0)
