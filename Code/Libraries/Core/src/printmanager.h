...
#else
#define DEBUGCATPRINTF( cat, level, format, ... ) ((void)0)
#define DEBUGLEVELPRINTF( level, format, ... ) ((void)0)
#define DEBUGPRINTF( format, ... ) ((void)0)
#endif // BUILD_DEBUG
...
public:
	...
	void					VPrintf( const HashedString& Category, int Level, const char* Format, va_list Args );
